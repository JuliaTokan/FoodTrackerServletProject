...
<fmt:message bundle="${locale}" key="label.sub" var="sub"/>
<fmt:message bundle="${locale}" key="button.start" var="start"/>
                    ...
                    <div class="col-xl-10 ">
                        <div class="slider_text text-center">
                            <div class="text">
                                ...
                                <h2 class="h2-white">${sub}</h2>
                                <a href="/user/meals" class="genric-btn warning circle arrow e-large mr-40">${start}<span class="lnr lnr-arrow-right"></span></a>
                        </div>
                    </div>
                </div>
            </div>
